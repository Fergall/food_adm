            ...
            <div class="col-sm-8">
                <div class="tab-content">
                  <div id="home" class="tab-pane fade in active">
                    ...
                    <form action="{{ url('/productoNew') }}" method="post">
                        @if ($errors->any())
                        ...
                        <div class="form-group{{ $errors->has('producto_descripcion') ? ' has-error' : '' }}">
                            <label for="producto_descripcion">Descripción</label>
                            <textarea class="form-control" id="producto_descripcion" name="producto_descripcion">{{$producto->producto_descripcion}}
                            </textarea>
                            @if($errors->has('$producto->producto_descripcion'))
                                <span class="help-block">{{ $errors->first('$producto->producto_descripcion') }}</span>
                            @endif
                        </div>
